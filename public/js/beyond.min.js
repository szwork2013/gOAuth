...
function InitiateSideMenu() {
    ...
    function() {
        if ($("#sidebar").is(":visible") || $("#sidebar").toggleClass("hide"), $("#sidebar").toggleClass("menu-compact"), $(".sidebar-collapse").toggleClass("active"), n = $("#sidebar").hasClass("menu-compact"), $(".sidebar-menu").closest("div").hasClass("slimScrollDiv") && ($(".sidebar-menu").slimScroll({
            destroy: !0
...
$("#chat-link").click(function() {
    ...
    if ($("#qlchatbar").hasClass("open")) {
        $("#qlchatbar").removeClass("open");
    } else {
        $("#qlchatbar").toggleClass("open");
    }
    $("#chat-link").toggleClass("open")
});
$("#chatbar .chatbar-contacts .contact").on("click",
function() {
    $("#chatbar .chatbar-contacts").hide();
    $("#chatbar .chatbar-messages").show()
});
$("#chatbar .chatbar-messages .back").on("click",
function() {
